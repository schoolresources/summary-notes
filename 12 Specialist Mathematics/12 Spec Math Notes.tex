...
\title{12 SACE Specialist Mathematics Summarised Notes \\ (Unofficial)}
\author{}
\date{}
\maketitle
...
\subsection{Indefinite Integrals}
	...
	Lower function: $g(x)$ or $y_L$
	\begin{align}
		V=\pi \int_{a}^{b}\left(\left[f(x)\right]^2-\left[g(x)\right]^2\right)\,\dd{x}
	\end{align}
	\begin{center}
		or
	\end{center}
	\begin{align}
		V=\pi \int_{a}^{b}\left(y_U^2-y_L^2\right)\,\dd{x}
	\end{align}
