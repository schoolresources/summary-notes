...
\section{Integration}
	...
	Suppose we have a function in the form $f = u\times v$ where $u$ and $v$ are also functions. We know that to find the derivative of $f$, we utilise the product rule:
	\begin{align}
