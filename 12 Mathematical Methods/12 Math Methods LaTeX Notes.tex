...
\begin{flalign}
	&\quad \frac{d}{dx}\left[c\right]=0&&\\
	&\quad \frac{d}{dx}\left[x^n\right]=nx^{n-1}&&\\
	&\quad \frac{d}{dx}\left[cu(x)\right]=cu'(x)&&\\
	&\quad \frac{d}{dx}\left[u(x)\pm v(x)\right]=u'(x)\pm v'(x)&&
\end{flalign}
\dotfill
...
\begin{flalign}
	...
	&\quad \frac{d}{dx}\left[e^{f(x)}\right]=e^{f(x)}\times f'(x)&&
\end{flalign}
\dotfill
...
\begin{flalign}
	&\quad \frac{d}{dx}\left[\ln{x}\right]=\frac{1}{x},\ x>0&&\\
	&\quad \frac{d}{dx}\left[\ln{f(x)}\right]=\frac{f'(x)}{f(x)}&&
\end{flalign}
\dotfill
\subsection{Trigonometric Functions}
\begin{flalign}
	&\quad \frac{d}{dx}\left[\sin{x}\right]=\cos{x}&&\\
	&\quad \frac{d}{dx}\left[\cos{x}\right]=-\sin{x}&&\\
	&\quad \frac{d}{dx}\left[\tan{x}\right]=\frac{1}{cos^2{x}}&&\\
	&\quad \frac{d}{dx}\left[\sin{[f(x)]}\right]=\cos{[f(x)]}f'(x)&&\\
	&\quad \frac{d}{dx}\left[\cos{[f(x)]}\right]=-\sin{[f(x)]}f'(x)&&\\
	&\quad \frac{d}{dx}\left[\tan{[f(x)]}\right]=\frac{f'(x)}{cos^2{[f(x)]}}&&
\end{flalign}
\hrulefill
...
\begin{flalign}
	&\quad \int k\ dx=kx+c&&\\
	&\quad \int x^n\ dx=\frac{1}{n+1}x^{n+1}+c,\ n\neq -1&&\\
...
\begin{flalign}
	&\quad \int (ax+b)^n\ dx=\frac{(ax+b)^{n+1}}{a(n+1)}+c,&&\\
	&\quad \qquad n\neq -1&&\\
	&\quad \int e^{ax+b}\ dx=\frac{1}{a}e^{ax+b}+c&&\\
	&\quad \int \frac{1}{ax+b}\ dx=\frac{1}{a}\ln{|ax+b|}+c&&\\
	&\quad \int \cos{(ax+b)}\ dx&&\\
	&\quad \qquad =\frac{1}{a}\sin{(ax+b)}+c&&\\
	&\quad \int \sin{(ax+b)}\ dx&&\\
...
\begin{flalign}
	...
	&\text{Variance:}\\
	&\quad \text{Var}(X)=\sigma ^2=\int_{a}^{b}x^2f(x)\ dx-\mu ^2&&\\
	&\text{or}&&\\
	&\quad \text{Var}(X)=\sigma ^2=\int_{a}^{b}(x-\mu)^2f(x)\ dx&&\\
	&\text{Standard Deviation:}&&\\
	&\quad \sigma =\sqrt{\int_{a}^{b}x^2f(x)\ dx-\mu ^2}&&\\
	&\text{or}&&\\
	&\quad \sigma =\sqrt{\int_{a}^{b}(x-\mu)^2f(x)\ dx}&&
\end{flalign}
\dotfill
